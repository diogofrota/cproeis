...
*/
function inicializarMenuHamburgerBloqueioDesbloqueio() {
  ...
  function definirEstadoMenu(shouldOpen) {
    ...
    menuToggle.setAttribute('aria-label', shouldOpen ? 'Fechar menu de bloqueio e desbloqueio' : 'Abrir menu de bloqueio e desbloqueio');
...
inicializarMenuHamburgerBloqueioDesbloqueio();
