...
*/
function inicializarMenuHamburgerP1Unidade() {
  ...
  function definirEstadoMenu(shouldOpen) {
    ...
    menuToggle.setAttribute('aria-label', shouldOpen ? 'Fechar menu da P/1 Unidade' : 'Abrir menu da P/1 Unidade');
...
inicializarMenuHamburgerP1Unidade();
