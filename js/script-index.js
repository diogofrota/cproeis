...
*/
function inicializarMenuHamburgerSistema() {
  ...
  function definirEstadoMenu(shouldOpen) {
    ...
    menuToggle.setAttribute('aria-label', shouldOpen ? 'Fechar menu do sistema' : 'Abrir menu do sistema');
...
inicializarMenuHamburgerSistema();
